...
//public class CSUFLoginGUI {
//    private static Institutions institutionID;
//    public static void main(String[] args) {
//        institutionID = Institutions.CSUF;
//        SwingUtilities.invokeLater(client.gui.CSUF.LoginGUI::renderLoginGUI);
//    }
//
...
//
//        try {
//            BufferedImage originalImage = ImageIO.read(new File(ClientConfig.CSUF_LOGO_FILE_PATH));
