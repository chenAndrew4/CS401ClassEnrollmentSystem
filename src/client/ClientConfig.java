...
public class ClientConfig {
    ...
    public static final String ENROLL_ICON = ICON_FILE_PATH_PREFIX + "enroll.png";
    public static final String DROP_ICON = ICON_FILE_PATH_PREFIX + "drop.png";
    public static final String WAITLIST_ICON = ICON_FILE_PATH_PREFIX + "waitlist.png";
    public static final String GRADES_ICON = ICON_FILE_PATH_PREFIX + "grades.png";
...
//    public static final String SJSU_FILE_PATH_PREFIX = ICON_FILE_PATH_PREFIX + "SJSU/";
//    public static final String CSUEB_FILE_PATH_PREFIX = ICON_FILE_PATH_PREFIX + "CSUEB/";
//    public static final String CSUF_FILE_PATH_PREFIX = ICON_FILE_PATH_PREFIX + "SJSU/";
//    public static final String SJSU_LOGO_FILE_PATH = SJSU_FILE_PATH_PREFIX + "logo.png";
//    public static final String CSUF_LOGO_FILE_PATH = CSUF_FILE_PATH_PREFIX + "logo.png";
//    public static final String CSUEB_LOGO_FILE_PATH = CSUEB_FILE_PATH_PREFIX + "logo.png";
//    public static final String SJSU_DASH_BACKGROUND_FILE_PATH = SJSU_FILE_PATH_PREFIX + "dashboard_background.png";
//    public static final String CSUF_DASH_BACKGROUND_PATH = CSUF_FILE_PATH_PREFIX + "dashboard_background.png";
//    public static final String CSUEB_DASH_BACKGROUND_PATH = CSUEB_FILE_PATH_PREFIX + "dashboard_background.png";
//    public static final String INVALID_CREDS_FILE_PATH =ICON_FILE_PATH_PREFIX + "invalid_creds.png";
//    public static final String DEFAULT_DASH_BACKGROUND_PATH = ICON_FILE_PATH_PREFIX + "dashboard_background.png";
//    public static final String DEFAULT_STUDENT_ICON = ICON_FILE_PATH_PREFIX + "student.png";
}
